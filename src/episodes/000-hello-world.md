...
Taking a moment to introduce ourselves and let the world know we're starting a podcast. Get subscribed, share with your friends and coworkers, and follow the show! We're [@workingcode.dev on Bluesky](https://bsky.app/profile/workingcode.dev).
...
[github]: https://github.com/WorkingCodePod/workingcode/blob/main/src/episodes/000-hello-world.md
...
[00:00:00] **Ben:** Well, I'll start recording now, just in case, just in case some magic happens,
...
[00:00:30] **Adam:** Hey, Tim, it's Adam. Hey, how you been? So I got a question for you. Yeah, shoot. Uh, you want to do a podcast with me? What? Yeah. About what? Well, I was thinking maybe just kind of like, uh, shoot the _(quack)_, uh, you know, uh, hallway track at a conference, water cooler, hanging out at the bar, just talking about, uh, coding, but not about any particular code, if that makes sense.
